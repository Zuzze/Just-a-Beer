...
export const HangoutData = [
{
    ...
    fromTime: new Date(),
    toTime: new Date(),
    description: "HOSTING Is anyone up for just one beer tonight? Just one",
    place: "Södermalm",
...
},
{
    ...
    fromTime: new Date(),
    toTime: new Date(),
    description: "PENDING Tech people in town, do you know some nice cafe to work? let's go together!",
...
},
{
    ...
    fromTime: new Date(),
    toTime: new Date(),
    description: "CONFIRMED Anyone interested in Italy game?",
    place: "Östermalm",
    types: [EventTypes[0]],
    owner: UserData[3].id,
    pendingUsers: [],
